...
echo $payresult;
//$payresult=str_replace('\\','',$payresult);
            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDemail" value="<?php echo $payresult['email'];?>" />
                        <span>必填
</span>
                    </dd>
                    <dt>付款账户名：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDaccount_name" value="<?php echo $payresult['account_name'];?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDpay_date" value="<?php echo $payresult['pay_date'];?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_no" value="<?php echo $payresult['batch_no'];?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_fee" value="<?php echo $payresult['batch_fee'];?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_num" value="<?php echo $payresult['batch_num'];?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDdetail_data" value="<?php echo $payresult['detail_data'];?>"/>
