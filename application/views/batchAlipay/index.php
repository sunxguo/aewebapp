            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDemail" value="fd@fengdukeji.com" />
                        <span>必填
</span>
                    </dd>
                    <dt>付款账户名：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDaccount_name" value="太原市风度科技有限公司"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDpay_date" value="<?php echo date('Ymd');?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_no" value="<?php echo date('YmdHis');?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_fee" value="<?php echo $cash_money;?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_num" value="<?php echo 1;?>"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDdetail_data" value="<?php echo $cash_id.'^'.$cash_account_account.'^'.$cash_account_owner_name.'^'.$cash_money.'^nihao';?>"/>
