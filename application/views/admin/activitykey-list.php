...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 搜索审核员管理 <span class="c-gray en">&gt;</span>活动关键字管理 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				<td><input type="checkbox" value="<?php echo $buyer->activity_id;?>" name="id"></td>
				<td>
				...
				<td>
					<?php if(!empty($buyer->activity_name)):?>
						<?php echo $buyer->activity_name;?>				    	
				    <?php endif;?>
				</td>

				<td>
					<?php if(!empty($buyer->activity_keyword)):?>
						<?php echo $buyer->activity_keyword;?>
					<?php else:?>
				    	暂无关键字
				    <?php endif;?>
				</td>
				...
				<td>
					<?php if(!empty($buyer->activity_begintime)):?>
						<?php echo $buyer->activity_begintime;?>
				    <?php endif;?>
				</td>

                <td>
					<?php if(!empty($buyer->activity_endtime)):?>
						<?php echo $buyer->activity_endtime;?>
				    <?php endif;?>
				</td>
				...
				<td class="td-manage">
					<?php if($buyer->audit_status=='0'):?>
						<a style="text-decoration:none" onClick="member_start(this,'<?php echo $buyer->activity_id;?>')" href="javascript:;" title="审核">
...
function member_start(obj,id){
	layer.confirm('确认要启用吗？',function(index){
		var buyer = new Object(); 
	    buyer.infoType = 'activitykeyword';
	    buyer.activity_id = id;
