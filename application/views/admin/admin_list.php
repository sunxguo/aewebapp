...
<div class="pd-20">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				<td><input type="checkbox" value="<?php echo $buyer->admin_id;?>" id="admin_id" name="id"></td>
				...
				<td>
					<?php echo $buyer->typename->type_name;?>		
				</td>
				...
				<td class="td-manage">
					...
					<?php endif;?>-->
					<a title="编辑" href="javascript:;" onclick="member_edit('修改用户信息','/admin/updateadmin','<?php echo $buyer->admin_id;?>','600','270')" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6df;</i>
					</a> 
