  ...
  <form class="form form-horizontal" id="form-member-add">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="name" name="name" datatype="*1-16" nullmsg="分类不能为空">
      </div>
      <div class="col-4"> </div> 
    </div>

     <div class="row cl">
        <label class="form-label col-3"><span class="c-red">*</span>一级分类描述：</label>
            <div class="formControls col-5">
              <textarea type="text" class="input-text" placeholder="" id="describe_shop" name="describe_shop" datatype="*" nullmsg="分类描述不能为空"></textarea>
            </div>
        <div class="col-4"> </div>
    </div>
