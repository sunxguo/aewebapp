  ...
  <form class="form form-horizontal" id="form-member-add">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        ...
        <input type="text" class="input-text" value="" placeholder="" id="msg_content" name="msg_content" datatype="*2-100000" nullmsg="提示内容不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5 skin-minimal">
        <div class="radio-box">
          <input type="radio" id="msg_status-1" name="msg_status" value="0" datatype="*" checked="checked">
          <label for="status-1">不显示</label>
        </div>
        <div class="radio-box">
          <input type="radio" id="msg_status-2" name="msg_status" value="1">
