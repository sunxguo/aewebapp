...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			...
			<a href="javascript:;" onclick="member_add('添加优惠券','/admin/getdiscountadd','','550')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加优惠券</a>
		</span> 
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php foreach($getdiscount as $count):?>
			<tr class="text-c">
				<td><input type="checkbox" value="<?php echo $count->coupon_id;?>" name="id"></td>
				<td><?php echo $count->coupon_id;?></td>
				<td><?php echo $count->coupon_facevalue;?></td>
				<td><?php echo $count->coupon_useprice;?></td>
				<td><?php echo $count->coupon_beginvalid;?></td>
				<td><?php echo $count->coupon_endvalid;?></td>
				<td><?php echo $count->coupon_addtime;?></td>
				<?php if($count->coupon_status=='0'):?>
				...
				<td class="td-manage">
					...
					<a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo $count->coupon_id;?>')" class="ml-5" style="text-decoration:none">
...
function member_stop(obj,id){
	layer.confirm('确认要下架吗？',function(index){
	    ...
	    count.id = id;
	    count.status = 1;
	    dataHandler('/common/modifyInfo',count,null,null,null,function(){
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
	    ...
	    count.infoType = 'count';
	    count.id = id;
		dataHandler('/common/updateproducts',count,null,null,null,function(){
