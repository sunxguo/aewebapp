	...
	<table class="table table-border table-bordered table-hover table-bg table-sort" width="2500">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<!--<td class="td-manage">
					<?php if($shop->shop_status=='0'):?>
					<a style="text-decoration:none" onClick="member_stop(this,'<?php echo $shop->shop_id;?>')" href="javascript:;" title="停用">
						<i class="Hui-iconfont">&#xe631;</i>
					</a> 
					<?php else:?>
					<a style="text-decoration:none" onClick="member_start(this,'<?php echo $shop->shop_id;?>')" href="javascript:;" title="启用">
						<i class="Hui-iconfont">&#xe6e1;</i>
					</a> 
					<?php endif;?>					
				</td>-->
