  ...
  <form class="form form-horizontal" id="form-member-add">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        ...
        <input type="text" class="input-text" value="" placeholder="" id="ad_spot_type_name" name="ad_spot_type_name" datatype="*1-16" nullmsg="广告时间不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="" placeholder="" id="ad_spot_type_unit_price" name="ad_spot_type_unit_price" datatype="*1-16" nullmsg="类型单价不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
