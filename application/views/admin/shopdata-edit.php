...
<div class="pd-20">
  ...
  <form class="form form-horizontal" id="form-member-add">
    ...
    <!--  <div class="row cl">
      ...
      <div class="formControls col-5"> 
        <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'coupon_endvalid\')||\'%y-%M-%d\'}'})" id="coupon_beginvalid" class="input-text Wdate" value="<?php echo $shopdata->activity_begintime;?>">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'coupon_beginvalid\')}'})" id="coupon_endvalid" class="input-text Wdate" value="<?php echo $shopdata->activity_endtime;?>">
      </div>
    </div> -->
