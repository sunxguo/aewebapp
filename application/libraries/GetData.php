...
class GetData
{
    ...
    {
        $condition = array('table' => 'websiteconfig', 'result' => 'data');
        if ($info != "ALLINFO")
            $condition['where'] = array('key_websiteconfig' => $info);
        $result = $this->CI->dbHandler->selectData($condition);
        if ($info != "ALLINFO")
            return $result[0]->value_websiteconfig;
        else {
            $newArray = array();
    ...
    public function getPageLink($baseUrl, $selectUrl, $currentPage, $amountPerPage,
        $amount)
    {
        $pageAmount = ceil($amount / $amountPerPage);
        $page = array(
            'firstPage' => ($currentPage != 1) ? $baseUrl . '&page=1' : 'no',
            'lastPage' => ($currentPage != $pageAmount && $pageAmount != 0) ? $baseUrl .
                '&page=' . $pageAmount : 'no',
            'prevPage' => ($currentPage > 1) ? $baseUrl . '&page=' . ($currentPage - 1) :
                'no',
            'nextPage' => ($currentPage < $pageAmount) ? $baseUrl . '&page=' . ($currentPage +
                1) : 'no',
    ...
    */
    ...
    {
        $condition = array('table' => 'user', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'goods', 'result' => $parameters['result']);
        if (isset($parameters['gender'])) {
            $condition['where']['gender'] = $parameters['gender'] == "NULL" ? null : $parameters['gender'];
        }
        if (isset($parameters['orderBy'])) {
    ...
    {
        $condition = array('table' => 'coupon', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'wordlist', 'result' => $parameters['result']);
    ...
    */
    ...
    {
        $condition = array('table' => 'admin', 'result' => $parameters['result']);
        // if(isset($parameters['gender'])){
        // 	$condition['where']['gender']=$parameters['gender']=="NULL"?NULL:$parameters['gender'];
        // }
        // if(isset($parameters['orderBy'])){
    ...
    {
        $condition = array('table' => 'admintype', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'adtime', 'result' => $parameters['result']);
        if (isset($parameters['gender'])) {
            $condition['where']['gender'] = $parameters['gender'] == "NULL" ? null : $parameters['gender'];
        }
        if (isset($parameters['orderBy'])) {
    ...
    {
        $condition = array('table' => 'adspottype', 'result' => $parameters['result']);
        if (isset($parameters['gender'])) {
            $condition['where']['gender'] = $parameters['gender'] == "NULL" ? null : $parameters['gender'];
        }
        if (isset($parameters['orderBy'])) {
    ...
    {
        $condition = array('table' => 'activity', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'businessdistrict', 'result' => $parameters['result']);
        if (isset($parameters['orderBy'])) {
            $condition['order_by'] = $parameters['orderBy'];
        }
        if (isset($parameters['limit'])) {
    ...
    {
        $condition = array('table' => 'category', 'result' => $parameters['result']);
    ...
    {
        $parameters = array('result' => 'data', 'orderBy' => array('addtime' => 'ASC'));
    ...
    {
        $condition = array('table' => 'categoryfeature', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'reminder', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'categoryeigenvalue', 'result' => $parameters['result']);
        ...
        if ($parameters['result'] == 'data') {
            foreach ($catefeature as $key => $value) {
                $value->category = $this->getCateFeatures('categoryfeature', $value->
                    eigen_feature_id)->feature_name;
            }
        }
        return $catefeature;
    }
    ...
    */
    ...
    {
        $condition = array('table' => 'followshop', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'stickshop', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'collectshop', 'result' => $parameters['result']);
    ...
    */
    ...
    {
        $condition = array('table' => 'adspot', 'result' => $parameters['result']);
        ...
        if ($parameters['result'] == 'data') {
            foreach ($products as $key => $value) {
                ...
                $value->category = $this->getAdCategoryById('adspottype', $value->
                    ad_spot_type_id, 'ad_spot_type_id');
                $value->activity = $this->getActivityById('activity', $value->
                    ad_spot_activity_id, 'activity_id');
            }
        }
        return $products;
    }
    ...
    */
    ...
    {
        $parameters = array('result' => 'data', 'orderBy' => array('feature_addtime' =>
                    'ASC'));
    ...
    public function getFeatureByShopId($parameters)
    {
        ...
        //$condition['where']['feature_category_id']=$parameters['cateid'];
        $condition['where']['feature_id'] = $parameters['cateid'];
        $catefeature = $this->getData($condition);
        return $catefeature;
    }
    ...
    {
        $condition = array('table' => 'userorder', 'result' => $parameters['result']);
        ...
        if ($parameters['result'] == 'data') {
            foreach ($orders as $key => $value) {
                ...
                $value->address = $this->getUseraddress('useraddress', $value->
    ...
    {
        $condition = array('table' => 'annuityshop', 'result' => $parameters['result']);
    ...
    */
    ...
    {
        $condition = array('table' => 'useraddress', 'result' => $parameters['result']);
    ...
    */
    ...
    {
        $condition = array('table' => 'shoprecharge', 'result' => $parameters['result']);
    ...
    {
        $condition = array('table' => 'shopcashout', 'result' => $parameters['result']);
        if (isset($parameters['shopid'])) {
    ...
    {
        $condition = array('table' => 'shopexpense', 'result' => $parameters['result']);
        if (isset($parameters['shopid'])) {
    ...
    {
        $condition = array('table' => 'shopaccount', 'result' => $parameters['result']);
        if (isset($parameters['shopid'])) {
    ...
    {
        $condition = array('table' => 'reportshop', 'result' => $parameters['result']);
        if (isset($parameters['orderBy'])) {
            $condition['order_by'] = $parameters['orderBy'];
        }
